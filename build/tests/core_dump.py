...
class Cores:
    ...
    def find_binary_fullpath(self, core):
        ...
        # to retrieve "Core was generated by `c/test-cd'."
        ...
        for line in tmp.split('\n'):
            ...
            if not reg:
                continue
            # may be statd -n platform.statd.Statd
            exe = reg.group(1).split(' ')[0]
            fullpath = osp.realpath("{0}/{1}".format(self.rootpath, exe))
            break
