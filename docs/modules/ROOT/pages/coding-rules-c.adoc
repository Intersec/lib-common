...
very_long_type_tag_t *
something_not_very_short(int, bar_t *, int, void *); /* good */
----
...
static void
something_not_very_short(my_not_short_struct_t *a,
                         my_not_short_struct_t *b); /* bad, could fit on only 2 lines */

static void
something_not_very_short(my_not_short_struct_t *a, my_not_short_struct_t *b); /* good */

static void something_not_very_short(my_not_short_struct_t *a,
                                     my_not_short_struct_t *b); /* good */

static void something_not_very_very_very_short(
    my_not_very_very_very_short_struct_t *a,
    my_not_very_very_very_short_struct_t *b); /* good */
...

{
    ...
    variable = long_fonction_with_parameters(parameter1, parameter2,             /* good */
                                             parameter3);
...
* When declaring a type, keep the opening bracket on the same line, then put a
  mandatory line break. For a `typedef`, keep the type name on the same line
