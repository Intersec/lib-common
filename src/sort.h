...
bisect8(uint8_t what, const uint8_t data[], size_t len, bool *found);
static inline size_t
bisect_i8(int8_t what, const int8_t data[], size_t len, bool *found);
static inline bool contains8(uint8_t what, const uint8_t data[], size_t len);
static inline bool contains_i8(int8_t what, const int8_t data[], size_t len);
...
static inline bool
contains16(uint16_t what, const uint16_t data[], size_t len);
static inline bool
contains_i16(int16_t what, const int16_t data[], size_t len);
...
static inline bool
contains32(uint32_t what, const uint32_t data[], size_t len);
static inline bool
contains_i32(int32_t what, const int32_t data[], size_t len);
...
static inline bool
contains64(uint64_t what, const uint64_t data[], size_t len);
static inline bool
contains_i64(int64_t what, const int64_t data[], size_t len);
...
#include "core/sort-numeric.in.h"
...
size_t uniq(
    void *data, size_t size, size_t nmemb, cmp_r_t *cmp, void *cmp_arg,
    del_r_t *nullable del, void *del_arg
);
size_t bisect(
    const void *what, const void *data, size_t size, size_t nmemb,
...
size_t uniq_blk(
    void *data, size_t size, size_t nmemb, cmp_b cmp, del_b nullable del
);
size_t bisect_blk(
    const void *what, const void *data, size_t size, size_t nmemb,
    bool *found, cmp_b cmp
);
bool contains_blk(
    const void *what, const void *data, size_t size, size_t nmemb, cmp_b cmp
);
#endif
