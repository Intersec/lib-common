...
#  define GET_PTR(st, spec, typ) ((typ *)((char *)(st) + (spec->offset)))
...
#  define ASN1_DESC(st_pfx) const asn1_desc_t *asn1_##st_pfx##_desc(void)
...
#  define ASN1_COMMON_FIELDS(ctype_t, st_pfx, field, tg, typ, mod, ptd)      \
      .name = #field, .oc_t_name = #ctype_t,                                 \
      .offset = offsetof(st_pfx##_t, field), .type = ASN1_OBJ_TYPE(typ),     \
      .tag = tg, .tag_len = 1, .mode = ASN1_OBJ_MODE(mod),                   \
      .size = sizeof(ctype_t), .pointed = ptd
...
#  define ASN1_REG_SCALAR_WITH_MODE(st_pfx, ctype_t, field, tag, mode)       \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  ctype_t, st_pfx, field, tag, ctype_t, mode, false          \
              ),                                                             \
          };                                                                 \
...
#  define asn1_reg_scalar(st_pfx, field, tag)                                \
      do {                                                                   \
          if (__builtin_types_compatible_p(                                  \
                  fieldtypeof(st_pfx##_t, field), bool                       \
              ))                                                             \
          {                                                                  \
          ...
          __error__(                                                         \
              #st_pfx "_t->" #field " type is not a supported scalar type"   \
          );                                                                 \
      } while (0)
...
#  define asn1_reg_opt_null(st_pfx, bool_field, tag)                         \
      do {                                                                   \
          if (ASN1_IS_FIELD_TYPE(bool, bool_field, st_pfx)) {                \
              asn1_field_t tmp = (asn1_field_t){ASN1_COMMON_FIELDS(          \
                  bool, st_pfx, bool_field, tag, OPT_NULL, OPTIONAL, false   \
              )};                                                            \
              asn1_reg_field(ASN1_ST_DESC_VAR(st_pfx), &tmp);                \
              break;                                                         \
          }                                                                  \
...
#  define ASN1_REG_SEQ_OF_STRING(st_pfx, field, tag)                         \
      do {                                                                   \
          ...
          if (ASN1_IS_FIELD_TYPE(                                            \
                  ASN1_VECTOR_TYPE(bit_string), field, st_pfx                \
              ))                                                             \
          {                                                                  \
              ASN1_REG_STRING(                                               \
                  st_pfx, asn1_bit_string_t, field, tag, SEQ_OF              \
              );                                                             \
              break;                                                         \
          }                                                                  \
          __error__("incorrect field type regarding desc");                  \
...
#  define ASN1_REG_OPEN_TYPE(st_pfx, ctype_t, mode, field)                   \
      do {                                                                   \
          asn1_field_t tmp = {                                               \
              ASN1_COMMON_FIELDS(                                            \
                  ctype_t, st_pfx, field, 0, OPEN_TYPE, mode, false          \
              ),                                                             \
          };                                                                 \
          asn1_reg_field(ASN1_ST_DESC_VAR(st_pfx), &tmp);                    \
      } while (0)
...
#  define asn1_reg_opaque(st_pfx, ctype, pfx, field, tag)                    \
      do {                                                                   \
          if (ASN1_IS_FIELD_TYPE(ctype, field, st_pfx)) {                    \
              ASN1_REG_OPAQUE(                                               \
                  st_pfx, ctype, pfx, field, tag, MANDATORY, false           \
              );                                                             \
              break;                                                         \
          }                                                                  \
          if (ASN1_IS_FIELD_TYPE(ctype *, field, st_pfx) ||                  \
          ...
          {                                                                  \
              ASN1_REG_OPAQUE(                                               \
                  st_pfx, ctype, pfx, field, tag, MANDATORY, true            \
              );                                                             \
              break;                                                         \
          }                                                                  \
...
#  define asn1_reg_opt_opaque(st_pfx, ctype, pfx, field, tag)                \
      do {                                                                   \
          ...
          {                                                                  \
              ASN1_REG_OPAQUE(                                               \
                  st_pfx, ctype, pfx, field, tag, OPTIONAL, true             \
              );                                                             \
              break;                                                         \
          }                                                                  \
...
#  define asn1_reg_seq_of_opaque(st_pfx, ctype, pfx, field, tag)             \
      do {                                                                   \
          ...
          if (ASN1_IS_FIELD_TYPE(ASN1_VECTOR_TYPE(pfx)), field, st_pfx) {    \
              ASN1_REG_OPAQUE(                                               \
                  st_pfx, ctype, pfx, field, tag, SEQ_OF, false              \
              );                                                             \
              break;                                                         \
          }                                                                  \
          ...
          __error__(                                                         \
              #st_pfx "_t ->" #field                                         \
                      " type is not a correct seq_of " ctype_t " type"       \
          );                                                                 \
      } while (0)
...
#  define ASN1_REG_OPAQUE(st_pfx, ctype_t, pfx, field, tag, mode, pointed)   \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  ctype_t, st_pfx, field, tag, OPAQUE, mode, pointed         \
              ),                                                             \
              .u = {                                                         \
                  .opaque = {                                                \
...
#  define ASN1_REG_SEQUENCE(st_pfx, pfx, field, tag, mode, pointed)          \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  pfx##_t, st_pfx, field, tag, SEQUENCE, mode, pointed       \
              ),                                                             \
              .u = {                                                         \
                  .comp = ASN1_GET_DESC(pfx),                                \
              },                                                             \
          };                                                                 \
          if (tmp.u.comp->type != ASN1_CSTD_TYPE_SEQUENCE) {                 \
              e_panic(                                                       \
                  "incorrect sub-type for " #st_pfx "_t:" #pfx ":" #field    \
                  ", expected SEQUENCE"                                      \
              );                                                             \
          }                                                                  \
          asn1_reg_field(ASN1_ST_DESC_VAR(st_pfx), &tmp);                    \
...
#  define ASN1_REG_CHOICE(st_pfx, pfx, field, tag, mode, pointed)            \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  pfx##_t, st_pfx, field, tag, CHOICE, mode, pointed         \
              ),                                                             \
              .u = {                                                         \
                  .comp = ASN1_GET_DESC(pfx),                                \
              },                                                             \
...
#  define asn1_reg_untagged_choice(st_pfx, pfx, field)                       \
      do {                                                                   \
          if (ASN1_IS_FIELD_TYPE(pfx##_t, field, st_pfx)) {                  \
              ASN1_REG_UNTAGGED_CHOICE(                                      \
                  st_pfx, pfx, field, MANDATORY, false                       \
              );                                                             \
              break;                                                         \
          }                                                                  \
          if (ASN1_IS_FIELD_TYPE(pfx##_t *, field, st_pfx) ||                \
...
#  define ASN1_REG_UNTAGGED_CHOICE(st_pfx, pfx, field, mode, pointed)        \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  pfx##_t, st_pfx, field, ASN1_TAG_INVALID, UNTAGGED_CHOICE, \
                  mode, pointed                                              \
              ),                                                             \
              .u = {                                                         \
                  .comp = ASN1_GET_DESC(pfx),                                \
...
#  define ASN1_REG_EXT(st_pfx, field, tag, mode)                             \
      do {                                                                   \
          asn1_field_t tmp = (asn1_field_t){                                 \
              ASN1_COMMON_FIELDS(                                            \
                  asn1_ext_t, st_pfx, field, tag, asn1_ext_t, mode, false    \
              ),                                                             \
          };                                                                 \
          asn1_reg_field(ASN1_ST_DESC_VAR(st_pfx), &tmp);                    \
      } while (0)
