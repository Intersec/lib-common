...
static inline asn1_field_t *asn1_desc_get_last_field(asn1_desc_t *desc)
{
...
static inline asn1_field_t *asn1_desc_get_int_field(asn1_desc_t *desc)
{
    ...
    {
        e_panic(
            "field `%s:%s' is not an number field", field->name,
            field->oc_t_name
        );
    }
...
static inline void(asn1_set_int_min)(asn1_desc_t *desc, int64_t min)
{
    ...
    asn1_int_info_update(
        &field->int_info, asn1_field_type_is_signed_int(field->type)
    );
}
...
static inline asn1_field_t *asn1_desc_get_str_field(asn1_desc_t *desc)
{
    asn1_field_t *field = asn1_desc_get_last_field(desc);
    ...
    {
        e_panic(
            "field `%s:%s' is not an string field", field->name,
            field->oc_t_name
        );
    }
...
static inline void(asn1_set_str_min)(asn1_desc_t *desc, size_t min)
{
...
static inline void(asn1_set_str_max)(asn1_desc_t *desc, size_t max)
{
    asn1_field_t *field = asn1_desc_get_str_field(desc);
...
static inline void(asn1_set_str_min_max)(
    asn1_desc_t *desc, size_t min, size_t max
)
{
...
static inline void(asn1_str_set_extended)(asn1_desc_t *desc)
{
    asn1_field_t *field = asn1_desc_get_str_field(desc);
...
static inline asn1_field_t *asn1_desc_get_seq_of_field(asn1_desc_t *desc)
{
    asn1_field_t *field = asn1_desc_get_last_field(desc);
    ...
    if (field->type != ASN1_OBJ_TYPE(SEQUENCE)) {
        e_panic(
            "field `%s:%s' is not a SEQUENCE field", field->name,
            field->oc_t_name
        );
    }
    ...
    if (!field->u.comp->is_seq_of) {
        e_panic(
            "field into `%s:%s' is not a SEQUENCE OF field", field->name,
            field->oc_t_name
        );
    }
...
static inline void(asn1_set_seq_of_min)(asn1_desc_t *desc, size_t min)
{
...
static inline void(asn1_set_seq_of_max)(asn1_desc_t *desc, size_t max)
{
    asn1_field_t *field = asn1_desc_get_seq_of_field(desc);
...
static inline void(asn1_set_seq_of_min_max)(
    asn1_desc_t *desc, size_t min, size_t max
)
{
...
static inline void(asn1_seq_of_set_extended)(asn1_desc_t *desc)
{
    asn1_field_t *field = asn1_desc_get_seq_of_field(desc);
...
static inline void(asn1_set_seq_of_extended_min_max)(
    asn1_desc_t *desc, size_t min, size_t max
)
{
    asn1_field_t *field = asn1_desc_get_seq_of_field(desc);
...
#  define asn1_set_seq_of_extended_min_max(st_pfx, min, max)                 \
        (asn1_set_seq_of_extended_min_max)(                                  \
            ASN1_ST_DESC_VAR(st_pfx), (min), (max)                           \
        )
 ...
 */
#define asn1_enum_reg_val(val) asn1_enum_append(info, val);

#define asn1_enum_reg_extension() info->extended = true;

#define asn1_enum_reg_ext_defval(v) asn1_enum_info_reg_ext_defval(info, (v))
...
static inline void(asn1_set_enum_info)(
    asn1_field_t *field, const asn1_enum_info_t *info
)
{
    if (!field) {
    ...
    if (field->type != ASN1_OBJ_TYPE(enum)) {
        e_panic("%s:%s is not an enum field", field->name, field->oc_t_name);
    }

    if (field->enum_info) {
        e_panic(
            "cannot set enum info for %s:%s - info already set", field->name,
            field->oc_t_name
        );
    }
...
#define ASN1_SEQ_OF_DESC_END(st_pfx)                                         \
      ...
      assert(                                                                \
          ASN1_ST_DESC_VAR(st_pfx)->fields.tab[0].mode ==                    \
...
static inline void(asn1_set_open_type)(asn1_desc_t *desc, size_t buf_len)
{
    asn1_field_t *field = asn1_desc_get_last_field(desc);
    ...
    if (field->is_open_type) {
        e_panic(
            "cannot set open type for %s:%s - already set", field->name,
            field->oc_t_name
        );
    }
