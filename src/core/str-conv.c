...
uint32_t const __utf8_offs[6] = {0x00000000UL, 0x00003080UL, 0x000e2080UL,
...
uint32_t const __str_unicode_general_ci[512] = {
    ...
    0x005F, // 0058
    0x0060,  0x0041,  0x0042,  0x0043,  0x0044,  0x0045,  0x0046,
    0x0047, // 0060
    0x0048,  0x0049,  0x004A,  0x004B,  0x004C,  0x004D,  0x004E,
    0x004F, // 0068
    0x0050,  0x0051,  0x0052,  0x0053,  0x0054,  0x0055,  0x0056,
    0x0057, // 0070
    0x0058,  0x0059,  0x005A,  0x007B,  0x007C,  0x007D,  0x007E,
    0x007F, // 0078

    0x0080,  0x0081,  0x0082,  0x0083,  0x0084,  0x0085,  0x0086,
    0x0087, // 0080
    0x0088,  0x0089,  0x008A,  0x008B,  0x008C,  0x008D,  0x008E,
    0x008F, // 0088
    0x0090,  0x0091,  0x0092,  0x0093,  0x0094,  0x0095,  0x0096,
    0x0097, // 0090
    0x0098,  0x0099,  0x009A,  0x009B,  0x009C,  0x009D,  0x009E,
    0x009F, // 0098
    0x00A0,  0x00A1,  0x00A2,  0x00A3,  0x00A4,  0x00A5,  0x00A6,
    0x00A7, // 00A0
    ...
    'G',     'H',     'H',     'H',     'H',     'I',     'I',
    'I',     'I',     'I',     'I',     'I',     'I',     'I',
    'I',     P(I, J), P(I, J), 'J',     'J',     'K',     'K',
    0x0138,  'L',     'L',     'L',     'L',     'L',     'L',
    'L',     'L',     'L',     'L',     'N',     'N',     'N',
    'N',     'N',     'N',     'N',     'N',     'N',     'O',
    'O',     'O',     'O',     'O',     'O',     P(O, E), P(O, E),
    'R',     'R',     'R',     'R',     'R',     'R',     'S',
    'S',     'S',     'S',     'S',     'S',     'S',     'S',
    'T',     'T',     'T',     'T',     'T',     'T',     'U',
    'U',     'U',     'U',     'U',     'U',     'U',     'U',
    ...
    'B',     'B',     0x0182,  0x0182,  0x0184,  0x0184,  0x0186,
    'C', // 0180
    'C',     'D',     'D',     0x018B,  0x018B,  0x018D,  0x018E,
    0x018F, // 0188
    0x0190,  0x0191,  0x0191,  'G',     0x0194,  0x01F6,  0x0196,
    0x0197, // 0190
    0x0198,  0x0198,  0x023D,  0x019B,  0x019C,  0x019D,  0x0220,
    0x019F, // 0198
    'O',     'O',     0x01A2,  0x01A2,  0x01A4,  0x01A4,  0x01A6,
    0x01A7, // 01A0
    0x01A7,  0x01A9,  0x01AA,  0x01AB,  0x01AC,  0x01AC,  0x01AE,
    0x01AF, // 01A8
    0x01AF,  0x01B1,  0x01B2,  0x01B3,  0x01B3,  'Z',     'Z',
    0x01B7, // 01B0
    0x01B8,  0x01B8,  0x01BA,  0x01BB,  0x01BC,  0x01BC,  0x01BE,
    0x01F7, // 01B8
    0x01C0,  0x01C1,  0x01C2,  0x01C3,  P(D, Z), P(D, Z), P(D, Z),
    P(L, J), // 01C0
    P(L, J), P(L, J), P(N, J), P(N, J), P(N, J), 'A',     'A',
    'I', // 01C8
    'I',     'O',     'O',     'U',     'U',     'U',     'U',
    'U', // 01D0
    'U',     'U',     'U',     'U',     'U',     0x018E,  'A',
    'A', // 01D8
    'A',     'A',     P(A, E), P(A, E), 'G',     'G',     'G',
    'G', // 01E0
    'K',     'K',     'O',     'O',     'O',     'O',     0x01EE,
    0x01EE, // 01E8
    'J',     P(D, Z), P(D, Z), P(D, Z), 'G',     'G',     0x01F6,
    0x01F7, // 01F0
    'N',     'N',     'A',     'A',     P(A, E), P(A, E), 'O',
    'O', // 01F8
};
#undef P
#undef A
...
uint32_t const __str_unicode_general_cs[512] = {
    ...
    0x0058,  0x0059,  0x005A,  0x005B,  0x005C,  0x005D,  0x005E,
    0x005F, // 0058
    0x0060,  0x0061,  0x0062,  0x0063,  0x0064,  0x0065,  0x0066,
    0x0067, // 0060
    ...
    'b',     'B',     0x0182,  0x0183,  0x0184,  0x0185,  0x0186,
    'C', // 0180
    'c',     'D',     'D',     0x018B,  0x018C,  0x018D,  0x018E,
    0x018F, // 0188
    0x0190,  0x0191,  0x0192,  'G',     0x0194,  0x0195,  0x0196,
    0x0197, // 0190
    0x0198,  0x0199,  0x019A,  0x019B,  0x019C,  0x019D,  0x019E,
    0x019F, // 0198
    'O',     'o',     0x01A2,  0x01A3,  0x01A4,  0x01A5,  0x01A6,
    0x01A7, // 01A0
    0x01A8,  0x01A9,  0x01AA,  0x01AB,  0x01AC,  0x01AD,  0x01AE,
    0x01AF, // 01A8
    0x01B0,  0x01B1,  0x01B2,  0x01B3,  0x01B4,  'Z',     'z',
    0x01B7, // 01B0
    0x01B8,  0x01B9,  0x01BA,  0x01BB,  0x01BC,  0x01BD,  0x01BE,
    0x01BF, // 01B8
    0x01C0,  0x01C1,  0x01C2,  0x01C3,  P(D, Z), P(D, z), P(d, z),
    P(L, J), // 01C0
    P(L, j), P(l, j), P(N, J), P(N, j), P(n, j), 'A',     'a',
...
static int utf8_strcmp_(
    const char *str1, int len1, const char *str2, int len2, bool strip,
    bool starts_with, uint32_t const str_conv[], int str_conv_len
)
{
    int c1, c2, cc1, cc2;
    int off1 = 0, off2 = 0;
...
{
    return utf8_strcmp_(
        str1, len1, str2, len2, strip, false, __str_unicode_general_ci,
...
{
    return utf8_strcmp_(
        str1, len1, str2, len2, strip, false, __str_unicode_general_cs,
        countof(__str_unicode_general_cs)
    );
}

int utf8_str_istartswith(
    const char *str1, int len1, const char *str2, int len2
)
{
    return !utf8_strcmp_(
        str1, len1, str2, len2, false, true, __str_unicode_general_ci,
        countof(__str_unicode_general_ci)
    );
}

int utf8_str_startswith(
    const char *str1, int len1, const char *str2, int len2
)
{
    return !utf8_strcmp_(
        str1, len1, str2, len2, false, true, __str_unicode_general_cs,
        countof(__str_unicode_general_cs)
    );
}
...
static int
sb_conv_from_ucs2_hex(sb_t *sb, const void *s, int slen, bool is_be)
{
...
static int sb_normalize_utf8_(
    sb_t *sb, const char *s, int len, uint32_t const str_conv[],
    int str_conv_len
)
{
    sb_t orig = *sb;
...
static int sb_utf8_transform(
    sb_t *sb, const char *s, int len, uint16_t const str_conv[],
    int str_conv_len
)
{
    sb_t orig = *sb;
...
{
    if (ci) {
        return sb_normalize_utf8_(
            sb, s, len, __str_unicode_general_ci,
            countof(__str_unicode_general_ci)
        );
    } else {
        return sb_normalize_utf8_(
            sb, s, len, __str_unicode_general_cs,
            countof(__str_unicode_general_cs)
        );
    }
}
...
{
    return sb_utf8_transform(
        sb, s, len, __str_unicode_lower, countof(__str_unicode_lower)
    );
}
...
{
    return sb_utf8_transform(
        sb, s, len, __str_unicode_upper, countof(__str_unicode_upper)
    );
}
