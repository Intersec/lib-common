...
const char *nonnull skipspaces(const char *nonnull s) __attr_nonnull__((1));

__attr_nonnull__((1)) static inline char *nonnull vskipspaces(char *nonnull s)
{
    return (char *)skipspaces(s);
}

const char *nonnull strnextspace(const char *nonnull s) __attr_nonnull__((1));
__attr_nonnull__((1)) static inline char *nonnull vstrnextspace(
    char *nonnull s
)
{
...
const char *nonnull skipblanks(const char *nonnull s) __attr_nonnull__((1));
__attr_nonnull__((1)) static inline char *nonnull vskipblanks(char *nonnull s)
{
...
int strstart(
    const char *nullable str, const char *nonnull p,
    const char *nullable *nullable pp
);
static inline int vstrstart(
    char *nullable str, const char *nonnull p, char *nullable *nullable pp
)
{
...
const char *nullable stristrn(
    const char *nonnull haystack, const char *nonnull needle, size_t nlen
) __attr_nonnull__((1, 2));

__attr_nonnull__((1, 2)) static inline char *nullable vstristrn(
    char *nonnull haystack, const char *nonnull needle, size_t nlen
)
{
    return (char *)stristrn(haystack, needle, nlen);
}

__attr_nonnull__((1, 2)) static inline const char *nullable stristr(
    const char *nonnull haystack, const char *nonnull needle
)
{
    return stristrn(haystack, needle, strlen(needle));
}

__attr_nonnull__((1, 2)) static inline char *nullable vstristr(
    char *nonnull haystack, const char *nonnull needle
)
{
...
__attr_nonnull__((1, 2)) static inline bool strequal(
    const char *nonnull str1, const char *nonnull str2
)
{
...
int str_replace(const char search, const char replace, char *nonnull subject);
...
ssize_t path_dirpart(
    char *nonnull dir, ssize_t size, const char *nonnull filename
) __attr_leaf__;

__attr_nonnull__() const
    char *nonnull path_filepart(const char *nonnull filename);
__attr_nonnull__() static inline char *nonnull vpath_filepart(
    char *nonnull path
)
{
...
__attr_nonnull__() const
    char *nonnull path_extnul(const char *nonnull filename);
__attr_nonnull__() static inline char *nonnull vpath_extnul(
    char *nonnull path
)
{
...
int path_dirname(
    char *nonnull buf, int len, const char *nonnull path
) __attr_leaf__;
int path_basename(
    char *nonnull buf, int len, const char *nonnull path
) __attr_leaf__;
...
int path_simplify2(
    char *nonnull path, bool keep_trailing_slash
) __attr_leaf__;
#  define path_simplify(path) path_simplify2(path, false)
int path_canonify(
    char *nonnull buf, int len, const char *nonnull path
) __attr_leaf__;
char *nullable path_expand(
    char *nonnull buf, int len, const char *nonnull path
) __attr_leaf__;
 ...
 */
__attribute__((format(printf, 3, 0))) int path_va_extend(
    char buf[static PATH_MAX], const char *nonnull prefix,
    const char *nonnull fmt, va_list args
);
__attribute__((format(printf, 3, 4))) int path_extend(
    char buf[static PATH_MAX], const char *nonnull prefix,
...
int path_relative_to(
    char buf[static PATH_MAX], const char *nonnull from,
