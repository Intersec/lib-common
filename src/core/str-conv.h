...
int strconv_hexdecode(
    void *nonnull dest, int size, const char *nonnull src, int len
) __attr_leaf__;
int strconv_hexencode(
    char *nonnull dest, int size, const void *nonnull src, int len
) __attr_leaf__;
...
{
    return (unsigned)c < countof(__str_unicode_upper) ? __str_unicode_upper[c]
                                                      : c;
}

static inline int unicode_tolower(int c)
{
    return (unsigned)c < countof(__str_unicode_lower) ? __str_unicode_lower[c]
                                                      : c;
}
...
static inline int
utf8_getc_slow(const char *nonnull s, const char *nullable *nullable out)
{
    uint32_t ret = 0;
...
utf8_getc(const char *nonnull s, const char *nullable *nullable out)
{
...
static ALWAYS_INLINE int
utf8_ngetc(const char *nonnull s, int len, const char *nullable *nullable out)
{
...
static ALWAYS_INLINE int
utf8_ngetc_at(const char *nonnull s, int len, int *nonnull offp)
{
    int off = *offp;
    const char *out = NULL;
    int res;
...
static inline const char *nonnull
utf8_skip_valid(const char *nonnull s, const char *nonnull end)
{
    while (s < end) {
 ...
 */
int utf8_stricmp(
    const char *nonnull str1, int len1, const char *nonnull str2, int len2,
    bool strip
) __attr_leaf__;
...
static inline bool utf8_striequal(
    const char *nonnull str1, int len1, const char *nonnull str2, int len2,
    bool strip
)
{
...
static inline bool utf8_strequal(
    const char *nonnull str1, int len1, const char *nonnull str2, int len2,
    bool strip
)
{
