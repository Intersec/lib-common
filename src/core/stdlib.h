...
void is_rand_set_seed(unsigned int seed) __attr_leaf__;

int is_rand(void) __attr_leaf__;
 ...
 */
uint32_t rand32(void) __attr_leaf__;

/** Generate a 64bit random integer.
 */
uint64_t rand64(void) __attr_leaf__;
 ...
 * generated.
 */
int64_t rand_range(int64_t first, int64_t last) __attr_leaf__;
 ...
 */
void core_push_version(
    bool is_main_version, const char *nonnull name,
    const char *nonnull version, const char *nonnull git_revision
);
 ...
 */
void core_push_dep_revision(
    const char *nonnull dep_name, const char *nonnull dep_revision
);
