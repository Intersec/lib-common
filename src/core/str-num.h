...
__attr_nonnull__((1)) static inline unsigned long cstrtoul(
    const char *nonnull str, const char *nullable *nullable endp, int base
)
{
    return (strtoul)(str, (char **)endp, base);
}

__attr_nonnull__((1)) static inline unsigned long vstrtoul(
    char *nonnull str, char *nullable *nullable endp, int base
)
{
...
__attr_nonnull__((1)) static inline long cstrtol(
    const char *nonnull str, const char *nullable *nullable endp, int base
)
{
...
__attr_nonnull__((1)) static inline long vstrtol(
    char *nonnull str, char *nullable *nullable endp, int base
)
{
...
__attr_nonnull__((1)) static inline long long cstrtoll(
    const char *nonnull str, const char *nullable *nullable endp, int base
)
{
    return (strtoll)(str, (char **)endp, base);
}
__attr_nonnull__((1)) static inline long long vstrtoll(
    char *nonnull str, char *nullable *nullable endp, int base
)
{
...
__attr_nonnull__((1)) static inline unsigned long long cstrtoull(
    const char *nonnull str, const char *nullable *nullable endp, int base
)
{
    return (strtoull)(str, (char **)endp, base);
}
__attr_nonnull__((1)) static inline unsigned long long vstrtoull(
    char *nonnull str, char *nullable *nullable endp, int base
)
{
...
int strtoip(
    const char *nonnull p, const char *nullable *nullable endp
...
int memtoip(
    const void *nonnull p, int len, const byte * nullable * nullable endp
) __attr_leaf__ __attr_nonnull__((1));
int64_t memtollp(
    const void *nonnull s, int len, const byte * nullable * nullable endp
) __attr_leaf__ __attr_nonnull__((1));
...
int strtolp(
    const char *nonnull p, const char *nullable *nullable endp, int base,
    long *nullable res, int flags, long min, long max
) __attr_leaf__;
 ...
 */
int memtoll_ext(
    const void *nonnull p, int len, int64_t *nonnull out,
    const void *nullable *nullable endp, int base
);

int memtoull_ext(
    const void *nonnull p, int len, uint64_t *nonnull out,
    const void *nullable *nullable endp, int base
);

int strtoll_ext(
    const char *nonnull s, int64_t *nonnull out,
    const char *nullable *nullable tail, int base
);

int strtoull_ext(
    const char *nonnull s, uint64_t *nonnull out,
    const char *nullable *nullable tail, int base
);
 ...
 * subnormal values.
 */
double strtod_allow_subnormal(
    const char *nonnull nptr, char *nullable *nullable endptr
);

__attr_nonnull__((1)) static inline double memtod(
    const void *nonnull s, int len, const byte * nullable * nullable endptr
)
{
    if (!len) {
        errno = EINVAL;
