...
def gen_table_for_encoding(rfc_fn: str, out_fn: str | None, hdr_lines: str,
                           tbl_elem_t: str, tbl_name: str) -> None:
...
def walk_from(root: Tree, node: Tree,
              code_str: str) -> tuple[list[int], bool, bool, Tree]:
...
def get_huffman_st_table_as_c_array(rfc_fn: str, tbl_elem_t: str,
                                    tbl_name: str, chunk_bits: int) -> str:
...
def gen_table_for_decoding(rfc_fn: str, out_fn: str | None, hdr_lines: str,
                           tbl_elem_t: str, tbl_name: str,
                           chunk_bits: int) -> None:
    head = HDR_AUTOGENERATED
    license_comment = get_license_as_c_comment()
