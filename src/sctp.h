 ...
 */
int sctp_sendmsg(
    int s, const void *msg, size_t len, struct sockaddr *to, socklen_t tolen,
    uint32_t ppid, uint32_t flags, uint16_t stream_no, uint32_t timetolive,
    uint32_t context
);
 ...
 */
int sctp_recvmsg(
    int s, void *msg, size_t len, struct sockaddr *from, socklen_t *fromlen,
