...
iop_cfolder_err_t
iop_cfolder_feed_number(iop_cfolder_t *nonnull, uint64_t, bool is_signed);
iop_cfolder_err_t
iop_cfolder_feed_operator(iop_cfolder_t *nonnull, iop_cfolder_op_t);
iop_cfolder_err_t iop_cfolder_get_result(
    iop_cfolder_t *nonnull, uint64_t *nonnull res, bool *nullable is_signed
);
