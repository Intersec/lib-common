...
static inline int ps_get_be128(pstream_t *nonnull ps, uint128_t *nonnull res)
{
...
static inline int ps_get_le128(pstream_t *nonnull ps, uint128_t *nonnull res)
{
...
static inline int ps_get_cpu128(pstream_t *nonnull ps, uint128_t *nonnull res)
{
