...
#if !defined(IS_LIB_COMMON_ARITH_H) ||                                       \
    defined(IS_LIB_COMMON_ARITH_ENDIANESS_H)
...
#  define bswap16_const(x) ((((uint16_t)(x)) << 8) | (((uint16_t)(x)) >> 8))
...
static inline void *nonnull put_unaligned_cpu128(void *nonnull p, uint128_t x)
{
    return put_unaligned(p, x);
}
...
static inline le64_t cpu_to_le64(uint64_t x)
{
    return CPU_TO_LE(64, x);
}
static inline le128_t cpu_to_le128(uint128_t x)
{
    return CPU_TO_LE(128, x);
}
static inline uint16_t le_to_cpu16(le16_t x)
{
    return LE_TO_CPU(16, x);
}
static inline uint32_t le_to_cpu32(le32_t x)
{
    return LE_TO_CPU(32, x);
}
static inline uint64_t le_to_cpu64(le64_t x)
{
    return LE_TO_CPU(64, x);
}
static inline uint128_t le_to_cpu128(le128_t x)
{
...
static inline void *nonnull put_unaligned_le128(void *nonnull p, uint128_t x)
{
...
static inline be64_t cpu_to_be64(uint64_t x)
{
    return CPU_TO_BE(64, x);
}
static inline be128_t cpu_to_be128(uint128_t x)
{
    return CPU_TO_BE(128, x);
}
static inline uint16_t be_to_cpu16(be16_t x)
{
    return BE_TO_CPU(16, x);
}
static inline uint32_t be_to_cpu32(be32_t x)
{
    return BE_TO_CPU(32, x);
}
static inline uint64_t be_to_cpu64(be64_t x)
{
    return BE_TO_CPU(64, x);
}
static inline uint128_t be_to_cpu128(be128_t x)
{
...
static inline void *nonnull put_unaligned_be128(void *nonnull p, uint128_t x)
{
...
{
    const uint8_t *p8 = cast(const uint8_t *, p);
    return get_unaligned_le32(p8) |
           ((uint64_t)get_unaligned_le16(p8 + 4) << 32);
}

static inline uint64_t get_unaligned_be48(const void *nonnull p)
{
    const uint8_t *p8 = cast(const uint8_t *, p);
    return get_unaligned_be32(p8 + 2) |
           ((uint64_t)get_unaligned_be16(p) << 32);
}
