...
#define _ZBENCH_GROUP_EXPORT(_name)                                          \
    ...
    _zbenchmark_group_##_name##_register(void)                               \
    {                                                                        \
 ...
 */
#define _ZBENCH_LOOP()                                                       \
    for (int _zbenchmark_cnt = 0,                                            \
             _zbenchmark_end = _zbenchmark_get_nb_runs(                      \
                 _zbenchmark_current_group, &_zbenchmark_current             \
             );                                                              \
 ...
 */
bool _zbenchmark_should_run(
    const zbenchmark_group_t *group, const zbenchmark_t *bench
);
 ...
 */
void _zbenchmark_print_measure(
    const zbenchmark_group_t *group, const zbenchmark_t *bench,
