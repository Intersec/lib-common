...
static color_sample_t const bright_background_g[] = {
    ENTRY(TERM_COLOR_BRIGHTER(BLACK_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(RED_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(GREEN_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(YELLOW_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(BLUE_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(PURPLE_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(CYAN_BG)),
    ENTRY(TERM_COLOR_BRIGHTER(WHITE_BG)),
};
