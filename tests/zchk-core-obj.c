...
OBJ_CLASS(
    my_base_object, object, MY_BASE_OBJECT_FIELDS, MY_BASE_OBJECT_METHODS
)
...
OBJ_VTABLE(my_base_object) {
    ...
    cls->t_get_desc = t_my_base_object_get_desc;
    cls->get_a = my_base_object_get_a;
}
...
OBJ_CLASS(
    my_child_object, my_base_object, MY_CHILD_OBJECT_FIELDS,
    MY_CHILD_OBJECT_METHODS, bool
)
...
OBJ_VTABLE(my_child_object) {
    ...
    cls->t_get_desc = t_my_child_object_get_desc;
    cls->get_b = my_child_object_get_b;
    cls->get_extended_a = my_child_object_get_extended_a_0;
}
...
OBJ_EXT_VTABLE(my_child_object) {
    cls->get_extended_a = my_child_object_get_extended_a_1;
    cls->get_extended_b = my_child_object_get_extended_b;
}
...
OBJ_EXT_VTABLE_WITH_PRIO(my_child_object, OBJ_EXT_VTABLE_DEF_PRIO + 1) {
    cls->get_extended_a = my_child_object_get_extended_a_2;
}
...
Z_GROUP_EXPORT(core_obj)
{
    ...
    Z_TEST(refcounting) {
        ...
        obj_release(&obj);
        Z_ASSERT_NULL(
            obj, "obj_release() should reset the pointer if the "
        ...
        obj_release(&obj);
        Z_ASSERT_P(
            obj, "obj_release() should not reset the pointer if the "
        ...
        obj_delete(&obj);
        Z_ASSERT_NULL(
            obj, "obj_delete() should reset the object pointer "
        ...
        obj_delete(&obj);
        Z_ASSERT_NULL(
            obj, "obj_delete() should always reset the object pointer"
        );
