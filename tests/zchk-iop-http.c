...
static void z_http_iop_on_connection_error(
    http_iop_channel_remote_t *remote, int errnum)
{
    _G.query_conn_error = errnum;
}

static void z_http_iop_on_ready(http_iop_channel_t *channel)
{
                                    ...
                                    const sockunion_t *su)
{
    ...
    channel_cfg = (http_iop_channel_cfg_t){
        ...
        .on_connection_error_cb = &z_http_iop_on_connection_error,
        .on_ready_cb = &z_http_iop_on_ready,
    };
