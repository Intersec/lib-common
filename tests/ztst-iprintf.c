...
sprint_int_type sprint_ints[] = {
    ...
    { __LINE__,  0x00008000,  "32768",          "%hu" },

    { __LINE__,  0000123456,  "    123456",     "%10o" },
    { __LINE__,  0000123456,  "  00123456",     "%10.8o" },
    { __LINE__,  0000123456,  " 00123456",      "%9.8o" },
    { __LINE__,  0000123456,  "00123456",       "%8.8o" },
    { __LINE__,  0000123456,  "  00123456",     "%#10.8o" },
    { __LINE__,  0000123456,  " 00123456",      "%#9.8o" },
    { __LINE__,  0000123456,  "00123456",       "%#8.8o" },
...
sprint_ll_type sprint_lls[] = {

    { __LINE__, 0x00000000ULL,            "0",                      "%llx" },
    { __LINE__, 0x00000000ULL,            "0",                      "%llX" },
    { __LINE__, 0x00000000ULL,            "0",                      "%llu" },
    { __LINE__, 0x00000000ULL,            "0",                      "%lld" },
    { __LINE__, 0x00000000ULL,            "0",                      "%llo" },
    { __LINE__, 0xffff00000000208bULL,    "ffff00000000208b",       "%llx" },
    { __LINE__, 0xffff00000000208bULL,    "FFFF00000000208B",       "%llX" },
    { __LINE__, 0xffff00000000208bULL,    "18446462598732849291",   "%llu" },
    { __LINE__, 0xffff00000000208bULL,    "-281474976702325",       "%lld" },
    { __LINE__, 0xffff00000000208bULL,    "1777770000000000020213", "%llo" },
    { __LINE__, 18446462598732849291ULL,  "ffff00000000208b",       "%llx" },
    { __LINE__, 18446462598732849291ULL,  "FFFF00000000208B",       "%llX" },
    { __LINE__, 18446462598732849291ULL,  "18446462598732849291",   "%llu" },
    { __LINE__, 18446462598732849291ULL,  "-281474976702325",       "%lld" },
    { __LINE__, 18446462598732849291ULL,  "1777770000000000020213", "%llo" },
    { __LINE__, 18359476226655002763ULL,  "fec9f65b0000208b",       "%llx" },
    { __LINE__, 18359476226655002763ULL,  "FEC9F65B0000208B",       "%llX" },
    { __LINE__, 18359476226655002763ULL,  "18359476226655002763",   "%llu" },
    { __LINE__, 18359476226655002763ULL,  "-87267847054548853",     "%lld" },
    { __LINE__, 18359476226655002763ULL,  "1773117545540000020213", "%llo" },
    { __LINE__,  1234567891234567891LL,   "112210f4c023b6d3",       "%llx" },
    { __LINE__,  1234567891234567891LL,   "112210F4C023B6D3",       "%llX" },
    { __LINE__,  1234567891234567891LL,   "1234567891234567891",    "%llu" },
    { __LINE__,  1234567891234567891LL,   "1234567891234567891",    "%lld" },
    { __LINE__,  1234567891234567891LL,   "104420417230010733323",  "%llo" },
    { __LINE__, -1234567891234567891LL,   "eeddef0b3fdc492d",       "%llx" },
    { __LINE__, -1234567891234567891LL,   "EEDDEF0B3FDC492D",       "%llX" },
    { __LINE__, -1234567891234567891LL,   "17212176182474983725",   "%llu" },
    { __LINE__, -1234567891234567891LL,   "-1234567891234567891",   "%lld" },
    { __LINE__, -1234567891234567891LL,   "1673357360547767044455", "%llo" },
